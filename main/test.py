...
class SidebarFrame(tkb.Frame):
    ...
    def create_button(self, text, image_filename, pady=(16, 0)):
        ...
        return tkb.Button(master=self, image=img, text=text, fg_color="transparent", font=("Arial Bold", 14),
...
class ClientMainViewFrame(tk.Frame):
    def __init__(self, master=NONE):
        ...
        self.titleFrame = tkb.Frame(master=self, fg_color="transparent")
        ...
        self.timeLabel = tkb.Label(master=self.titleFrame, font=("Arial Black", 17), text_color="#2A8C55" )
        ...
        get_time()
        # Client Section
        self.clientGrid = tkb.Frame(master=self, fg_color="transparent")
        ...
        self.clientdetGrid = tkb.Frame(master=self, fg_color="transparent")
        ...
        #Fetch Details
        self.fetchDetGrid = tkb.Frame(master=self, fg_color="transparent")
